                        ...
                        <div className={styles.titleRateImgElementsMobile}>
                            ...
                            <div className="d-flex justify-content-center mt-4">
                                <div>
                                    {(count || count === 0) ? 
                                        <div className="mb-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-download text-primary" viewBox="0 0 16 16">
                                        ...
                                        null}
                                    {(like || like === 0) ? 
                                        <div className="badge bg-danger mb-2 d-block">
